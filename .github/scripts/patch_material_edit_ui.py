...
# Desktop API contract: expose immutable parent edits and the new version note field.
replace_once(
    "desktop/src/api.ts",
...
# Keep App integration small; editing form state lives in MaterialEditPanel.
replace_once(
    "desktop/src/App.tsx",
...
# Tauri IPC bridge for the Core edit endpoint.
rust_command = r'''
#[tauri::command]
