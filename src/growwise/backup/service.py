...
class BackupService:
        ...
        with tempfile.TemporaryDirectory(
            ...
            try:
                with zipfile.ZipFile(archive_path, "r") as archive:
                    # Validate names/counts/sizes before reading any member. In particular, do not
                    # inflate a hostile manifest into memory before enforcing its small hard cap.
    ...
    def _validate_members(cls, archive: zipfile.ZipFile) -> None:
        ...
        for info in members:
            ...
            # Backslashes are platform-dependent path separators on Windows. Reject them rather
            # than relying on extractall's normalization behavior to stay identical across OSes.
