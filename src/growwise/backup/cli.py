...
def restore_backup(settings: Settings, name: str, *, confirmed: bool) -> dict[str, object]:
    ...
    with DATA_MAINTENANCE.maintenance(invalidate_generation=True):
        # Reject malformed/semantically invalid archives before cancelling or deleting any
        # operational state. restore() validates again immediately before authoritative swap.
