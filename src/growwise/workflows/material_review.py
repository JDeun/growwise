...
class ResilientMaterialReviewGraph:
    ...
    GeneratedMaterial Markdown is authoritative. A checkpoint outage must not turn a committed
    material/version into an apparent failed request that callers retry into a sibling version. The
    domain transition service remains the authority for which review decisions are legal.
    """
