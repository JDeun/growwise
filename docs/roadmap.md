...
- ✅ **표현(UX)** — 방사형 **성장 지도**(점수판 아님, 관찰 기반)와 **활동 퀘스트**(강제
  과제 아닌 초대). 사상 가드레일은 [product-spec.md](product-spec.md).
...
- 나머지 생성 모듈(독서·영어·수학·과학·글쓰기 코치)을 순차 완성
- **영아(0-2) 모드**(발달·놀이·책 읽어주기·관찰 기록, 표준보육과정)
- **중·고 학습 트래킹·보조 모드**(진도·약점 지도·회고·부모 지원 포인트, PAIDEIA식)

→ **전 연령(0~고등)·전 기능 완성이 최종 목표**다.
