...
const material: GeneratedMaterial = { id: "m1", child_id: "c1", kind: "activity_guide", title: "활동", content_markdown: "# 활동", parent_guide_markdown: "", status: "review_pending", source_refs: [], generator_mode: "template", ai_status: "not_requested", ai_job_id: null, review_note: null, request_topic: "활동", request_goal: null, version: 1, parent_material_id: null, version_note: null };
...
describe("MaterialWorkspace mutation locking", () => {
  it("disables mutation controls while a material operation is running", () => {
    ...
    expect(html).toContain("기본 초안 저장 중…");
  });
});
