...
const HELP_GROUPS = [
  {
    ...
    items: [
      ...
      ["다음 활동 이어가기", "아이의 최근 질문과 기록에서 이어지는 활동을 준비하고, 해본 결과를 다시 다음 기록으로 남깁니다."],
    ],
  },
  {
    title: "데이터와 개인정보",
    items: [
      ["내 기기에 저장", "아이의 기록은 기본적으로 이 기기에 저장되고 백업도 사용자가 직접 관리합니다."],
  ...
  },
  {
    ...
    items: [
      ...
      ["로컬 AI 준비", "Ollama를 실행한 뒤 설정에서 기본 AI 준비를 선택하면 필요한 모델을 GrowWise가 준비합니다."],
    ...
    <section className="help-workspace" aria-labelledby="help-workspace-title">
      ...
      <section className="help-support-card">
        <div>
          ...
          <p>설정의 앱 상태에서 기본 기능과 AI 준비 상태를 각각 확인할 수 있습니다.</p>
        </div>
      </section>
    </section>
  );
